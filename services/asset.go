...
//FilterAsset :""
func (s *Service) FilterAsset(ctx *models.Context, assetFilter *models.AssetFilter, pagination *models.Pagination) (organisation []models.RefAsset, err error) {
