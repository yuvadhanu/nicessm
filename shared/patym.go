...
type PatymCheckSum struct{}

var IV = "@@@@&&&&####$$$$"

func (p *PatymCheckSum) GenerateSignature(body interface{}, key string) (string, error) {
	data, err := json.Marshal(body)
	if err != nil {
		return "", errors.New("Error in converting payment body - " + err.Error())
	}
	sign := GenerateSignatureByString(string(data), key)
	return sign, nil
}
